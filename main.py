...
#     if visits_count:
#         res = make_response(f"Вы пришли на страницу {visits_count + 1} раз")
#         res.set_cookie("visits_count", str(visits_count + 1), max_age=60 * 60 * 24 * 365 * 2)
#     else:
#         res = make_response(f"Вы пришли на страницу в первый раз за последние 2 года")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and user.check_password(form.password.data):
            ...
            return redirect("/")
        return render_template('login.html', massage='Неправильный логин или пароль', form=form)
